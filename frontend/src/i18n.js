...
export const translations = {
  vi: {
    ...
    auth_forgot_sent:
      'Nếu {email} đã đăng ký, chúng tôi vừa gửi link đặt lại mật khẩu tới hộp thư đó. Link có hiệu lực trong 1 giờ. Nhớ kiểm tra cả mục Spam.',
    auth_or: 'hoặc',
  ...
  en: {
    ...
    auth_forgot_sent:
      'If {email} is registered, we have just sent a password reset link to that inbox. The link is valid for 1 hour. Remember to check your Spam folder.',
    auth_or: 'or',
